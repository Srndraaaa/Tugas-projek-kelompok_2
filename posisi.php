    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="welcome">
                    <h1 class="page-title">Welcome, Jos Jis</h1>
            ...
            <div class="right-panel">
                ...
                <div class="posisi-card">
                    ...
                    <div class="posisi-item">
                        <div class="icon">👤</div> Supervisor
                    </div>
                    <div class="posisi-item">
                        <div class="icon">⚙️</div> Operator Mesin
                    </div>
                    <div class="posisi-item">
                        <div class="icon">🧾</div> Staff Admin
                    </div>
                    <div class="posisi-item">
                        <div class="icon">💻</div> Staff Akutansi
                    </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-row"><span>Total Pendaftar</span><span>128</span></div>
                    <div class="stat-row"><span>Diterima</span><span>64</span></div>
                    <div class="stat-row"><span>Ditolak</span><span>20</span></div>
                    <div class="stat-row"><span>Proses</span><span>44</span></div>
                </div>
...
new Chart(document.getElementById('barChart'), {
    type: 'bar',
    data: {
        labels: ['Supervisor','Operator Mesin','Staff Admin','Staff Akutansi'],
        datasets: [{
            data: [55,18,30,26],
